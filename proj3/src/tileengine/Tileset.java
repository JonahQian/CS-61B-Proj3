...
public class Tileset {
    ...
    public static final TETile FLOOR0 = new TETile('●', new Color(128, 192, 128), new Color(0, 0, 200), "floor", 13);
    public static final TETile FLOOR1 = new TETile('·', new Color(128, 192, 128), new Color(0, 0, 150), "floor", 14);
    public static final TETile FLOOR2 = new TETile('·', new Color(128, 192, 128), new Color(0, 0, 100), "floor", 15);
    public static final TETile FLOOR3 = new TETile('·', new Color(128, 192, 128), new Color(0, 0, 50), "floor", 16);
    public static final TETile FLOOR0CLOSED = new TETile('●', new Color(128, 192, 128), Color.black, "floor", 17);
